...
{
    int result = strcmp(letters, otherString.letters);
    if (result > 0)
        return GREATER;
    else if (result < 0)
        return LESS;
...
{
    int idx = 0;
    while ((letters[idx] != NULL && otherString.letters[idx] != NULL) && (letters[idx] == otherString.letters[idx]))
    {
        idx++;
    ...
    if (letters[idx] == NULL && otherString.letters[idx] != NULL)
        return LESS;
    else if (letters[idx] != NULL && otherString.letters[idx] == NULL)
        return GREATER;
    else if (letters[idx] == NULL && otherString.letters[idx] == NULL)
        return EQUAL;
}